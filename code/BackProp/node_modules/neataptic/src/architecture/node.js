...
function Node (type , key , bias) {
  this.key = key;
  this.bias = (type === 'input') ? 0 : bias;
  if(bias == undefined){
    this.bias = Math.random() * 0.2 - 0.1;
  }
  this.squash = methods.activation.RELU;
  this.type = type || 'hidden';
  this.distance = 0 //distance to output nodes
...
Node.prototype = {
  ...
  activate: function (input) {
    ...
    this.state = 0;//this.connections.self.gain * this.connections.self.weight * this.state + this.bias;
  
    // Activation sources coming from connections
    var i;
    for (i = 0; i < this.connections.in.length; i++) {
      var connection = this.connections.in[i];
      //console.log(connection.from.key + ' ' + connection.weight);
      this.state += connection.from.activation * connection.weight * connection.gain;
        //console.log("node = "+this.key+" , "+connection.from.activation+" * "+connection.weight+" = "+ connection.from.activation * connection.weight );
    }
    ...
    //console.log(this.key + ' ' + this.activation);
    return this.activation;
  },
