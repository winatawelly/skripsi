<?php
$data = file_get_contents("dataset/season15-16/season_stats.json");
//$data = file_get_contents("dataset/season14-15/season_stats.json");
        ...
        foreach($values2 as $key3 => $values3){
            if($key3 == 'team_details'){
                foreach($values3 as $key4 => $values4){
                    if($key4 == 'team_name' || $key4 == 'team_rating'){
...
$output_str =  $output_str.']';
$myfile = fopen("ValidInputTest.txt", "w") or die("Unable to open file!");
